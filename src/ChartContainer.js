...
const ChartContainer = () => {
    ...
    const handleClick = () => {
        ...
        try {
            ...
            let shapes = dataShapes.filter((d) => d.GWB_CODE.includes(result.Buurt2019));
            ...
            let dataShape = shapes.map((d) => {
                return [
                    ...
                    },
                    {
                        year: d.Jaar,
                        axis: 'Huisartsenpost',
                        value: d.ziekenhuis_excl_afst ? +d.ziekenhuis_excl_afst.replace(',', '.') : 0,
                    },
                    {
                        year: d.Jaar,
                        axis: 'Ziekenhuis',
                        value: d.ziekenhuis_incl_afst ? +d.ziekenhuis_incl_afst.replace(',', '.') : 0,
                    },
                    {
                        year: d.Jaar,
                        axis: 'Bibliotheek',
